...
![image](https://e25ba8-log4d-c.dijingchao.com/upload_dropbox/201105/eclipse-main.png)

配置Arguments页签的参数，添加serve --reload development.ini，后面的ini配置文件可以使用绝对路径。

![image](https://e25ba8-log4d-c.dijingchao.com/upload_dropbox/201105/eclipse-arguments.png)
