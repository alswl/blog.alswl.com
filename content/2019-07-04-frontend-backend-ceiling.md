...
前段时间和某大厂前端负责人 G 聊职业生涯发展，聊着聊着就谈到了前端和后端职业天花板。
我表达了自己观点：后端职业天花板更高，这是由职能细分决定。

后端概念比较宽泛，常见分类可以有应用开发工程师、中间件工程师、甚至某些场景下面可以包含运维、数据工程师、算法工程师。
这里我只将后端工程师限定在应用开发工程师。
...
是的，尽管 Web 前端近年发展迅猛，探索出多种新技术，从更广泛端技术来看，Android / iOS 也迎来爆炸式发展。
几乎隐隐有势头盖过后端趋势。
我肯定随着业务复杂度提升， Web Frontend / Android / iOS 开发困难度愈发提升；随着科技普惠云计算发展，
...
-   从直接实现业务升级往后端方向推进，加速整体研发效率
-   服务上下游工具链：比如数据打点
-   从服务业务变为服务其他前端，比如前端框架，Hybrid 框架

我给前端同学的建议：

-   不要被手头事情限制住，也不要被 Title 限制住，开阔自己的技术视野，
    一个案例 [bang](https://blog.cnbang.net/about/)，twitese / JSPatch 作者；这个建议对后端工程师同样合适。
-   往下深扎技术，往上投入到更抽象知识学习中。IE 优化技巧会过期，
    但是浏览器渲染流程和算法不会过期，HTTP1.1 到 HTTP 2.0 过程中，协议会变化，
    但是定义问题，解决问题思路不会过期；iOS / Android 之上语言会转变，
    但是基础资源调度、IO 模式、TCP 协议不会过期
