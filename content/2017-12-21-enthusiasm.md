...
对上下游的 Paterner 是否有帮助么？
前两天还看到一个阿里的开源项目 [alibaba/java-dns-cache-manipulator: A simple 0-dependency thread-safe Java™ lib/tool for setting dns programmatically without touching host file, make unit/integration test portable.](https://github.com/alibaba/java-dns-cache-manipulator)，
...
第一种路径是突破工作内容所需要的深度，
将工作关注的问题能够刨根问底。在平凡的工作机会上面做出彩来了。
...
的确，如果现在要求是 60 分，我们做 80 分可能是追求极致，
而逼自己做 120 分可能就过度设计了。
...
这时候即进入一个舒适区，是努力挣脱这种状态还是走出来，
取决于个人的追求。
努力调整自己，通过学习、体验、Review 的方式，来帮助自己成长。
当到达瓶颈期的时候，想办法从自身、外部寻找帮助，重新进入痛苦区，让自己能够成长。
