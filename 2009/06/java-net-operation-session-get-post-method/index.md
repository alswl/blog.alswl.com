...
[猛击这里下载cookiemanager](../../static/images/upload_dropbox/200906/cookiemanager.java) 同时你可以参考这个类作者的文章
...
最后再借花献佛，送上一个完整操作Http GET/POST的类[猛击这里下载httprequestproxy](../../static/images/upload_dropbox/200906/httprequestproxy.java)依然感谢原作者，
